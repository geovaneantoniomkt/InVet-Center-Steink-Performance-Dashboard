...
# valores do cliente-modelo (InVet Center) que precisam virar os do cliente novo
MODELO = {
    "nome": "InVet Center",
    "nome_legal": "InVet Center Limeira - Hospital Veterinario 24h",
    "slug": "invet-center",
    "cookie": "ic_sess",
    "meta_account": "COLOQUE_O_ID_DA_CONTA",
    "meta_business": "COLOQUE_O_ID_DO_BUSINESS",
    "meta_page": "COLOQUE_O_ID_DA_PAGINA",
    "meta_ig": "COLOQUE_O_ID_DO_INSTAGRAM",
    "pixel": "COLOQUE_O_ID_DO_PIXEL",
    "instagram": "usuario_do_instagram",
    "google_customer": "182-911-9223",
    "desde": "2025-01-01",
}


def prefixo_cookie(slug: str) -> str:
    """invet-center -> ic_sess ; invet-center -> no_sess"""
...
def main() -> int:
    ...
    # nome do cliente em minúsculas também aparece (invet-center-dashboard, invet-center.targets)
    trocas += [("invet-center", slug), ("INVET-CENTER", slug.upper())]
