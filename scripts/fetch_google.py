#!/usr/bin/env python3
"""
Coletor de dados do Google Ads para o dashboard InVet Center (Steink Performance).
...
Variáveis de ambiente:
  ...
  GOOGLE_ADS_LOGIN_CUSTOMER_ID   (recomendada) ID da conta administradora (MCC) que gerencia a InVet Center
  GOOGLE_ADS_CUSTOMER_ID         (padrão 182-911-9223) conta Google Ads da InVet Center
  GOOGLE_ADS_API_VERSION         (opcional) ex. v22; se vazio, tenta as versões mais recentes conhecidas
  GOOGLE_SINCE                   (padrão 2025-01-01) início da série diária
...
CUSTOMER_ID = re.sub(r"\D", "", os.environ.get("GOOGLE_ADS_CUSTOMER_ID", "182-911-9223"))
FORCED_VERSION = os.environ.get("GOOGLE_ADS_API_VERSION", "").strip()
SINCE = (os.environ.get("GOOGLE_SINCE") or "2025-01-01").strip()
